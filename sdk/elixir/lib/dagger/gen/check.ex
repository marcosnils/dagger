...
defmodule Dagger.Check do
  ...
  """
  @spec executed(t()) :: {:ok, boolean()} | {:error, term()}
  def executed(%__MODULE__{} = check) do
    query_builder =
      check.query_builder |> QB.select("executed")
  ...
  @spec success(t()) :: {:ok, boolean()} | {:error, term()}
  def success(%__MODULE__{} = check) do
    query_builder =
      check.query_builder |> QB.select("success")
